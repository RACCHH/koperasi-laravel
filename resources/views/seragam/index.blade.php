...
@endforeach
    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <td>{{ $data->ukuran }}</td>
            <td>
                <a class="btn shadow btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#edit-seragam{{ $data->id }}">edit</i></a>
                <a class="btn shadow btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#delete-seragam{{ $data->id }}">delete</i></a>
            </tr>
        </td>
            @endforeach
